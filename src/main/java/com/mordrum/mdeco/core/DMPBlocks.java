...
import com.mordrum.mdeco.item.DMPItemBrickSlab;
...
public class DMPBlocks {
   ...
   public void preInitAncientStoneBlocks() {
      ...
      for(int var4 = 0; var4 < var3; ++var4) {
         ...
         for(var8 = 0; var8 < var7; ++var8) {
            ...
            ModelBakery.registerItemVariants(Item.getItemFromBlock((Block)this.ancientBlocks.get(blockType.name())), new ResourceLocation[]{new ResourceLocation("mdeco:" + variantName)});
            variantName = String.format("%s_%s_slab", new Object[]{blockType.name(), variantHeadstone.name()});
            ModelBakery.registerItemVariants(Item.getItemFromBlock((Block)this.ancientSlabs.get(blockType.name())), new ResourceLocation[]{new ResourceLocation("mdeco:" + variantName)});
            variantName = String.format("%s_%s_slab_double", new Object[]{blockType.name(), variantHeadstone.name()});
            ModelBakery.registerItemVariants(Item.getItemFromBlock((Block)this.ancientSlabsDouble.get(blockType.name())), new ResourceLocation[]{new ResourceLocation("mdeco:" + variantName)});
            variantName = String.format("%s_%s_wall", new Object[]{blockType.name(), variantHeadstone.name()});
            ModelBakery.registerItemVariants(Item.getItemFromBlock((Block)this.ancientWalls.get(blockType.name())), new ResourceLocation[]{new ResourceLocation("mdeco:" + variantName)});
            variantName = String.format("%s_%s_pillar_large", new Object[]{blockType.name(), variantHeadstone.name()});
            ModelBakery.registerItemVariants(Item.getItemFromBlock((Block)this.ancientPillarsLarge.get(blockType.name())), new ResourceLocation[]{new ResourceLocation("mdeco:" + variantName)});
            variantName = String.format("%s_%s_pillar_small", new Object[]{blockType.name(), variantHeadstone.name()});
            ModelBakery.registerItemVariants(Item.getItemFromBlock((Block)this.ancientPillarsSmall.get(blockType.name())), new ResourceLocation[]{new ResourceLocation("mdeco:" + variantName)});
         }
         ...
         for(var8 = 0; var8 < var7; ++var8) {
            ...
            variantName = String.format("%s_headstone_%s", new Object[]{blockType.name(), var11.name()});
            ModelBakery.registerItemVariants(Item.getItemFromBlock((Block)this.ancientHeadstones.get(blockType.name())), new ResourceLocation[]{new ResourceLocation("mdeco:" + variantName)});
         }
      }
   ...
   public void preInitDecorations() {
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         DMPDecoration decoration = var3[var5];
         String variantName;
         int i;
         if(decoration.decorationType == DMPDecorationType.ingotStack) {
            for(i = 0; i < 6; ++i) {
               variantName = String.format("%s:%s%d", new Object[]{"mdeco", decoration.name(), Integer.valueOf(i)});
               ModelBakery.registerItemVariants(Item.getItemFromBlock((Block)this.ingotStack.get(decoration.name())), new ResourceLocation[]{new ResourceLocation(variantName)});
            }
         } else if(decoration.decorationType == DMPDecorationType.palletStack) {
            for(i = 0; i < 5; ++i) {
               variantName = String.format("%s:%s%d", new Object[]{"mdeco", decoration.name(), Integer.valueOf(i)});
               ModelBakery.registerItemVariants(Item.getItemFromBlock((Block)this.palletStack.get(decoration.name())), new ResourceLocation[]{new ResourceLocation(variantName)});
            }
         }
      }
   ...
   private void createAncientStoneBlocks() {
      ...
      for(int var6 = 0; var6 < var5; ++var6) {
         DMPAncientBlockType blockType = var4[var6];
...
//               Util.registerBlockAndItem(slabDouble, DMPItemBrickSlab.class, blockType.name() + "_slab_double");
   ...
   private void createBuildingBlocks() {
      ...
      for(int var3 = 0; var3 < var2; ++var3) {
         DMPBuildingBlock buildingBlock = var1[var3];
   ...
   private void createDecorationBlocks() {
      ...
      for(int var3 = 0; var3 < var2; ++var3) {
         DMPDecoration decoration = var1[var3];
         if(decoration.decorationType == DMPDecorationType.barrelLarge && MDeco.settings.contentBarrelLarge) {
            ...
            DMPReference.addToRegisteredBlocks(1);
         } else if(decoration.decorationType == DMPDecorationType.benchWoodMetalArm && MDeco.settings.contentBenchWoodMetalArm) {
            ...
            DMPReference.addToRegisteredBlocks(1);
         } else if(decoration.decorationType == DMPDecorationType.chairBasicArm && MDeco.settings.contentChairBasicArm) {
            this.chairBasicArm.put(decoration.name(), new DMPBlockChair(decoration));
            DMPReference.addToRegisteredBlocks(1);
         } else if(decoration.decorationType == DMPDecorationType.chandelierSmallRound && MDeco.settings.contentChandelierSmallRound) {
            ...
            DMPReference.addToRegisteredBlocks(1);
         } else if(decoration.decorationType == DMPDecorationType.endTableMetalRound && MDeco.settings.contentEndTableMetalRound) {
            ...
            DMPReference.addToRegisteredBlocks(1);
         } else if(decoration.decorationType != DMPDecorationType.fountainLava && decoration.decorationType != DMPDecorationType.fountainWater) {
            if(decoration.decorationType == DMPDecorationType.ingotStack) {
               ...
               DMPReference.addToRegisteredBlocks(1);
            } else if(decoration.decorationType == DMPDecorationType.palletStack && MDeco.settings.contentPalletStack) {
               ...
               DMPReference.addToRegisteredBlocks(1);
            } else if(decoration.decorationType == DMPDecorationType.poleMetalConnector && MDeco.settings.contentPoleMetal) {
               ...
               DMPReference.addToRegisteredBlocks(1);
            } else if(decoration.decorationType == DMPDecorationType.shopSignCornerCut && MDeco.settings.contentShopSignCornerCut) {
               this.shopSignCornerCut.put(decoration.name(), new DMPBlockShopSign(decoration));
               DMPReference.addToRegisteredBlocks(1);
            } else if(decoration.decorationType == DMPDecorationType.shopSignDome && MDeco.settings.contentShopSignDome) {
               this.shopSignDome.put(decoration.name(), new DMPBlockShopSign(decoration));
               DMPReference.addToRegisteredBlocks(1);
            } else if(decoration.decorationType == DMPDecorationType.shopSignGable && MDeco.settings.contentShopSignGable) {
               this.shopSignGable.put(decoration.name(), new DMPBlockShopSign(decoration));
               DMPReference.addToRegisteredBlocks(1);
            } else if(decoration.decorationType == DMPDecorationType.shopSignHexagon && MDeco.settings.contentShopSignHexagon) {
               this.shopSignHexagon.put(decoration.name(), new DMPBlockShopSign(decoration));
               DMPReference.addToRegisteredBlocks(1);
            } else if(decoration.decorationType == DMPDecorationType.shopSignRound && MDeco.settings.contentShopSignRound) {
               this.shopSignRound.put(decoration.name(), new DMPBlockShopSign(decoration));
               DMPReference.addToRegisteredBlocks(1);
            } else if(decoration.decorationType == DMPDecorationType.shopSignSquare && MDeco.settings.contentShopSignSquare) {
               ...
               DMPReference.addToRegisteredBlocks(1);
            } else if(decoration.decorationType == DMPDecorationType.standSmallWood && MDeco.settings.contentStandSmallWood) {
               this.standSmallWood.put(decoration.name(), new DMPBlockStandSmallWood(decoration));
               DMPReference.addToRegisteredBlocks(1);
            } else if(decoration.decorationType == DMPDecorationType.standSmallStone && MDeco.settings.contentStandSmallStone) {
               this.standSmallStone.put(decoration.name(), new DMPBlockStandSmall(decoration));
               DMPReference.addToRegisteredBlocks(1);
            } else if(decoration.decorationType == DMPDecorationType.standSmallMetal && MDeco.settings.contentStandSmallMetal) {
               this.standSmallMetal.put(decoration.name(), new DMPBlockStandSmall(decoration));
               DMPReference.addToRegisteredBlocks(1);
            } else if(decoration.decorationType == DMPDecorationType.standLargeStone && MDeco.settings.contentStandLargeStone) {
               this.standLargeStone.put(decoration.name(), new DMPBlockStandLarge(decoration));
               DMPReference.addToRegisteredBlocks(1);
            } else if(decoration.decorationType == DMPDecorationType.standLargeMetal && MDeco.settings.contentStandLargeMetal) {
               this.standLargeMetal.put(decoration.name(), new DMPBlockStandLarge(decoration));
               DMPReference.addToRegisteredBlocks(1);
            } else if(decoration.decorationType == DMPDecorationType.supportPole && MDeco.settings.contentSupportPole) {
               ...
               DMPReference.addToRegisteredBlocks(1);
            } else if(decoration.decorationType == DMPDecorationType.wallLantern && MDeco.settings.contentWallLantern) {
               ...
               DMPReference.addToRegisteredBlocks(1);
            } else if((decoration.decorationType == DMPDecorationType.woodTimber || decoration.decorationType == DMPDecorationType.woodBarkTimber) && MDeco.settings.contentWoodTimber) {
               ...
               DMPReference.addToRegisteredBlocks(1);
            } else if((decoration.decorationType == DMPDecorationType.woodTimberConnector || decoration.decorationType == DMPDecorationType.woodBarkTimberConnector) && MDeco.settings.contentWoodTimber) {
   ...
   private void initAncientStoneBlocks(RenderItem renderItem) {
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         ...
         for(var9 = 0; var9 < var8; ++var9) {
            ...
            variantName = String.format("%s_%s_block", new Object[]{blockType.name(), variantHeadstone.name()});
            renderItem.getItemModelMesher().register(Item.getItemFromBlock((Block)this.ancientBlocks.get(blockType.name())), variantHeadstone.getMetadata(), new ModelResourceLocation("mdeco:" + variantName, "inventory"));
            variantName = String.format("%s_%s_slab", new Object[]{blockType.name(), variantHeadstone.name()});
            renderItem.getItemModelMesher().register(Item.getItemFromBlock((Block)this.ancientSlabs.get(blockType.name())), variantHeadstone.getMetadata(), new ModelResourceLocation("mdeco:" + variantName, "inventory"));
            variantName = String.format("%s_%s_wall", new Object[]{blockType.name(), variantHeadstone.name()});
            renderItem.getItemModelMesher().register(Item.getItemFromBlock((Block)this.ancientWalls.get(blockType.name())), variantHeadstone.getMetadata(), new ModelResourceLocation("mdeco:" + variantName, "inventory"));
            variantName = String.format("%s_%s_pillar_large", new Object[]{blockType.name(), variantHeadstone.name()});
            renderItem.getItemModelMesher().register(Item.getItemFromBlock((Block)this.ancientPillarsLarge.get(blockType.name())), variantHeadstone.getMetadata(), new ModelResourceLocation("mdeco:" + variantName, "inventory"));
            variantName = String.format("%s_%s_pillar_small", new Object[]{blockType.name(), variantHeadstone.name()});
            renderItem.getItemModelMesher().register(Item.getItemFromBlock((Block)this.ancientPillarsSmall.get(blockType.name())), variantHeadstone.getMetadata(), new ModelResourceLocation("mdeco:" + variantName, "inventory"));
         }

         variantName = String.format("%s_stairs", new Object[]{blockType.name()});
         renderItem.getItemModelMesher().register(Item.getItemFromBlock((Block)this.ancientStairs.get(blockType.name())), 0, new ModelResourceLocation("mdeco:" + variantName, "inventory"));
         ...
         for(var9 = 0; var9 < var8; ++var9) {
            ...
            renderItem.getItemModelMesher().register(Item.getItemFromBlock((Block)this.ancientHeadstones.get(blockType.name())), var12.getMetadata(), new ModelResourceLocation("mdeco:" + variantName, "inventory"));
         }
      }
   ...
   private void initBuildingBlocks(RenderItem renderItem) {
      ...
      for(int var6 = 0; var6 < var5; ++var6) {
         DMPBuildingBlock buildingBlock = var4[var6];
         Item item = null;
         ...
         if(item != null && registerSingle) {
            renderItem.getItemModelMesher().register(item, 0, new ModelResourceLocation("mdeco:" + buildingBlock.name(), "inventory"));
         }
      }
   ...
   public boolean initDecorations(RenderItem renderItem) {
      ...
      for(int var7 = 0; var7 < var6; ++var7) {
         DMPDecoration decoration = var5[var7];
         Item item = null;
         boolean registerSingle = true;
         if(decoration.decorationType == DMPDecorationType.barrelLarge) {
            ...
            if(decoration.decorationType == DMPDecorationType.chain) {
               ...
               if(decoration.decorationType == DMPDecorationType.ingotStack) {
                  for(i = 0; i < 6; ++i) {
                     variant = String.format("%s:%s%d", new Object[]{"mdeco", decoration.name(), Integer.valueOf(i)});
                     renderItem.getItemModelMesher().register(Item.getItemFromBlock((Block)this.ingotStack.get(decoration.name())), i, new ModelResourceLocation(variant, "inventory"));
                  }
                  ...
                  if(decoration.decorationType == DMPDecorationType.mantle) {
                     ...
                     for(i = 0; i < 5; ++i) {
                        variant = String.format("%s:%s%d", new Object[]{"mdeco", decoration.name(), Integer.valueOf(i)});
                        renderItem.getItemModelMesher().register(Item.getItemFromBlock((Block)this.palletStack.get(decoration.name())), i, new ModelResourceLocation(variant, "inventory"));
                     }
         ...
         if(item != null && registerSingle) {
            renderItem.getItemModelMesher().register(item, 0, new ModelResourceLocation("mdeco:" + decoration.name(), "inventory"));
         }
      }
