...
public class DMPItemWoodTimber extends ItemBlock {
   private DMPBlockWoodTimber decorationBlock;

   public DMPItemWoodTimber(Block block) {
      super(block);
      this.setUnlocalizedName(block.getUnlocalizedName().substring(5));
      this.decorationBlock = (DMPBlockWoodTimber)block;
   }
