...
import com.mordrum.mdeco.item.DMPItemCoinStack;
...
public class DMPBlockCoinStack extends DMPBlockDirectional {
   protected static final AxisAlignedBB AABB = new AxisAlignedBB(0.125D, 0.0D, 0.125D, 0.875D, 0.3125D, 0.875D);

   public DMPBlockCoinStack(DMPDecoration decoration) {
      super(decoration);
      com.mordrum.mdeco.Util.registerBlockAndItem(this, DMPItemCoinStack.class, this.decoration.name());
