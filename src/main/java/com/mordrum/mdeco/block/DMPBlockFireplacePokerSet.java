...
import com.mordrum.mdeco.item.DMPItemFireplacePokerSet;
...
public class DMPBlockFireplacePokerSet extends DMPBlockDirectional {
   protected static final AxisAlignedBB AABB = new AxisAlignedBB(0.296875D, 0.0D, 0.296875D, 0.703125D, 1.0625D, 0.703125D);

   public DMPBlockFireplacePokerSet(DMPDecoration decoration) {
      super(decoration);
      com.mordrum.mdeco.Util.registerBlockAndItem(this, DMPItemFireplacePokerSet.class, this.decoration.name());
