...
import com.mordrum.mdeco.item.DMPItemBenchStone;
...
public class DMPBlockBenchStone extends DMPBlockConnectSides {
   ...
   public DMPBlockBenchStone(DMPDecoration decoration) {
      super(decoration);
      com.mordrum.mdeco.Util.registerBlockAndItem(this, DMPItemBenchStone.class, this.decoration.name());
