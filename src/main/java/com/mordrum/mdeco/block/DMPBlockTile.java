...
import com.mordrum.mdeco.item.DMPItemTile;
...
public class DMPBlockTile extends DMPBlockDirectional {
   protected static final AxisAlignedBB AABB = new AxisAlignedBB(0.0D, 0.0D, 0.0D, 1.0D, 0.0625D, 1.0D);

   public DMPBlockTile(DMPDecoration decoration) {
      super(decoration);
      com.mordrum.mdeco.Util.registerBlockAndItem(this, DMPItemTile.class, this.decoration.name());
