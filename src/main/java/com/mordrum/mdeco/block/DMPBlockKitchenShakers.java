...
import com.mordrum.mdeco.item.DMPItemKitchenShakers;
...
public class DMPBlockKitchenShakers extends DMPBlockBaseDecoration {
   protected static final AxisAlignedBB AABB = new AxisAlignedBB(0.21875D, 0.0D, 0.21875D, 0.78125D, 0.25D, 0.78125D);
   public static final PropertyDirection FACING;
   public static final PropertyEnum VARIANT;

   public DMPBlockKitchenShakers(DMPDecoration decoration) {
      super(decoration);
      this.setDefaultState(this.blockState.getBaseState().withProperty(FACING, EnumFacing.NORTH).withProperty(VARIANT, EnumType.basic));
      com.mordrum.mdeco.Util.registerBlockAndItem(this, DMPItemKitchenShakers.class, this.decoration.name());
