...
import com.mordrum.mdeco.item.DMPItemBenchWood;
...
public class DMPBlockBenchWood extends DMPBlockConnectSides {
   ...
   public DMPBlockBenchWood(DMPDecoration decoration) {
      super(decoration);
      com.mordrum.mdeco.Util.registerBlockAndItem(this, DMPItemBenchWood.class, this.decoration.name());
