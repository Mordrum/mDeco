...
public class DMPContainerSofa extends Container {
   private IInventory storageInventory;
   private int numSlots;

   public DMPContainerSofa(World worldIn, BlockPos pos, EntityPlayer player) {
      ...
      this.addSlotToContainer(new InputMaterial(this.storageInventory, 0, 50, 18));
      this.addSlotToContainer(new InputMaterial(this.storageInventory, 1, 110, 18));
      int playerSlots = 0;
   ...
   class InputMaterial extends Slot {
      ...
      public boolean isItemValid(ItemStack stack) {
         ...
         if(item == null) {
            ...
            return block == null?false:block == Blocks.WOOL;
         }
      }
