...
public class DMPContainerWoodCrate extends Container {
   private IInventory storageInventory;
   private int numSlots;

   public DMPContainerWoodCrate(World worldIn, BlockPos pos, EntityPlayer player) {
      ...
      for(k = 0; k < 9; ++k) {
         this.addSlotToContainer(new Slot(this.storageInventory, slotIndex++, 8 + k * 18, 72));
      }
