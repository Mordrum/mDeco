...
public class DMPTileEntityMarketStand extends TileEntityLockable implements IInventory {
	private static final int TOTAL_SLOTS = 18;
	private ItemStack[] storageItems = new ItemStack[18];
