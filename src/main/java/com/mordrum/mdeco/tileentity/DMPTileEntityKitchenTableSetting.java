...
public class DMPTileEntityKitchenTableSetting extends TileEntityLockable implements IInventory {
   ...
   public String getName() {
      return "DMPKitchenTableSettingTE";
   }
   ...
   public String getGuiID() {
      return "mdeco:kitchenTableSetting";
   }
