...
public class DMPTileEntityCabinetWallGlass extends TileEntityLockable implements IInventory {
   private static final int TOTAL_SLOTS = 8;
   private ItemStack[] storageItems = new ItemStack[8];
