...
public class DMPTileEntityMarketCrate extends TileEntityLockable implements IInventory {
   ...
   public void readFromNBT(NBTTagCompound compound) {
      ...
      this.displayText1 = compound.getString("DisplayText1");
      this.displayText2 = compound.getString("DisplayText2");
   }
   ...
   public NBTTagCompound writeToNBT(NBTTagCompound compound) {
      ...
      compound.setString("DisplayText1", this.displayText1);
      compound.setString("DisplayText2", this.displayText2);
      return compound;
   }
   ...
   public String getGuiID() {
      return "mdeco:marketCrate";
   }

   public String getDisplayText(int row) {
      return row == 2?this.displayText2:this.displayText1;
   }

   public void setDisplayText(String text1, String text2) {
      this.displayText1 = text1;
      this.displayText2 = text2;
