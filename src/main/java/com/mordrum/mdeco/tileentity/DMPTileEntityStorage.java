...
public abstract class DMPTileEntityStorage extends TileEntityLockable implements IInventory {
   private ItemStack[] storageItems = new ItemStack[36];
   public boolean open = false;
   public int numPlayersUsing = 0;
   private String blockData = "none";

   public DMPTileEntityStorage() {
   }

   public DMPTileEntityStorage(String data) {
      this.blockData = data;
   }
   ...
   public void readFromNBT(NBTTagCompound compound) {
      ...
      if(compound.hasKey("BlockData", 8)) {
         this.blockData = compound.getString("BlockData");
      }
   ...
   public NBTTagCompound writeToNBT(NBTTagCompound compound) {
      ...
      compound.setString("BlockData", this.blockData);
      return compound;
   }
