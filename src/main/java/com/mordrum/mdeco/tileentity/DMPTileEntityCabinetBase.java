...
public class DMPTileEntityCabinetBase extends TileEntityLockable implements IInventory {
   private static final int TOTAL_SLOTS = 37;
   private ItemStack[] storageItems = new ItemStack[37];
   ...
   public String getName() {
      return "container.cabinetBase";
   }

   public String getGuiID() {
      return "mdeco:cabinetBase";
   }
   ...
   public void closeInventory(EntityPlayer player) {
      if(!player.isSpectator() && this.getBlockType() instanceof DMPBlockCabinetBase) {
         --this.numPlayersUsing;
         this.world.addBlockEvent(this.pos, this.getBlockType(), 1, this.numPlayersUsing);
         this.world.notifyNeighborsOfStateChange(this.pos, this.getBlockType(), true);
      }
   ...
   public boolean isItemValidForSlot(int index, ItemStack stack) {
      if(index == 36) {
         ...
         return block instanceof DMPBlockTile;
      } else {
         return true;
      }
   }

   public Block getCountertopTile() {
      ItemStack stack = this.getStackInSlot(36);
      return stack != null?Block.getBlockFromItem(stack.getItem()):null;
   }
