...
public class DMPTileEntityShopSign extends TileEntityLockable implements IInventory {
   ...
   public void readFromNBT(NBTTagCompound compound) {
      ...
      this.signText1 = compound.getString("SignText1");
      this.signText2 = compound.getString("SignText2");
   }
   ...
   public NBTTagCompound writeToNBT(NBTTagCompound compound) {
      ...
      compound.setString("SignText1", this.signText1);
      compound.setString("SignText2", this.signText2);
	   return compound;
   }
   ...
   public Packet getDescriptionPacket() {
      ...
      return new SPacketUpdateTileEntity(this.pos, 0, nbttagcompound1);
   }
   ...
   public void closeInventory(EntityPlayer player) {
      if(!player.isSpectator() && this.getBlockType() instanceof DMPBlockShopSign) {
         --this.numPlayersUsing;
         this.world.addBlockEvent(this.pos, this.getBlockType(), 1, this.numPlayersUsing);
         this.world.notifyNeighborsOfStateChange(this.pos, this.getBlockType(), true);
      }
   ...
   public String getSignText(int row) {
      return row == 2?this.signText2:this.signText1;
   }

   public void setSignText(String text1, String text2) {
      this.signText1 = text1;
      this.signText2 = text2;
